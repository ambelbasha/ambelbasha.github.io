...
const numRows = Math.ceil(window.innerHeight / (hexagonHeight * 0.75)); // Adjusted vertical spacing
...
const verticalSpacing = -19; // Reduced vertical spacing between hexagons (adjusted by -19 pixels)
