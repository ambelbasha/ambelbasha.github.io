            ...
            <div class="box">
                ...
                function showAvg($result) {
                    ...
                    if ($count > 0) {
                        ...
                        echo "<div class='result average'>Average Item's Price: $avg_price €</div>";
                    } else {
                        echo "<div class='result no-items'>No items found</div>";
                    }
                }
                ...
                function showMin($result) {
                    ...
                    if ($min_item !== "") {
                        echo "<div class='result minimum'>Item with Minimum Price: $min_item $min_price €</div>";
                    } else {
                        echo "<div class='result no-items'>No items found</div>";
                    }
                }
                ...
                function showMax($result) {
                    ...
                    if ($max_item !== "") {
                        echo "<div class='result maximum'>Item with Maximum Price: $max_item $max_price €</div>";
                    } else {
                        echo "<div class='result no-items'>No items found</div>";
                    }
                }
                ...
                switch ($action) {
                    ...
                    case "Maximum":
                        ...
                        break;
                    default:
                        echo "<div class='result no-items'>Invalid action selected</div>";
                        break;
                }
